...
{
       0,    43,    43,    47,    56,    59,    60,    63,    68,    79,
      80,    83,    92,    93,   100,   109,   112,   117,   125,   132,
     141,   144,   153,   156,   157,   158,   159,   160,   163,   164,
     168,   173,   181,   188,   190,   195,   200,   203,   207,   214,
     219,   222,   223,   224,   225,   226,   227,   230,   235,   238,
     239,   242,   247,   250,   251,   254,   255,   256,   257,   260,
     267,   268,   271,   280
};
#endif
...
{
  "$end", "error", "$undefined", "\"then\"", "ELSE", "IF", "INT",
  "RETURN", "VOID", "WHILE", "NUM", "ID", "PLUS", "MINUS", "TIMES", "OVER",
  "LT", "LE", "GT", "GE", "EQ", "NE", "ASSIGN", "SEMI", "COMMA", "LPAREN",
  "RPAREN", "LBRACE", "RBRACE", "LCURLY", "RCURLY", "LCOM", "RCOM",
...
{
      48,   -63,   -63,    17,    48,   -63,   -63,    11,   -63,   -63,
     -63,    37,   -63,    55,    32,    39,    46,    42,    45,   -63,
      43,    47,    44,    48,    49,    50,   -63,   -63,   -63,   -63,
     -63,    48,   -63,    64,     4,     9,    51,    -4,    52,   -63,
     -15,   -63,    -9,   -63,   -63,   -63,   -63,   -63,   -63,   -63,
      56,    58,   -63,    31,   -11,   -63,   -63,    -9,   -63,    59,
      -9,    -9,    -9,    57,   -63,    -9,   -63,   -63,   -63,   -63,
     -63,   -63,   -63,   -63,    -9,    -9,   -63,   -63,    -9,    60,
     -63,    61,   -63,    62,    65,    53,   -63,   -63,   -63,    33,
     -11,   -63,    30,    30,   -63,    -9,   -63,    80,   -63,   -63,
      30,   -63
};
...
{
     -63,   -63,   -63,    81,    63,    -5,   -63,   -63,   -63,    67,
      69,   -63,   -63,   -62,   -63,   -63,   -63,   -63,   -37,    -8,
     -63,   -63,    18,   -63,    20,   -63,    15,   -63,   -63,   -63
};
...
static const yytype_int8 yytable[] =
{
      ...
      39,    40,    20,    66,    67,    66,    67,    68,    69,    70,
      71,    72,    73,    41,     1,    42,     2,    21,    99,    26,
      12,     1,    13,    15,    14,   -13,    88,    88,    22,    23,
      88,    24,    29,    26,    25,    35,    57,    60,    30,    64,
      65,    96,    80,    86,   100,    10,    92,    93,    94,    95,
      28,    27,    89,    91,    32,    90
};

static const yytype_uint8 yycheck[] =
{
      37,    10,    11,    14,    15,    42,    10,    11,    13,     5,
      25,     7,    27,     9,    10,    11,    25,     0,    23,    23,
      57,    25,    11,    60,    61,    62,    31,    23,    65,    25,
      92,    93,    23,    29,    30,     5,    27,     7,   100,     9,
      10,    11,    10,    12,    13,    12,    13,    16,    17,    18,
      19,    20,    21,    23,     6,    25,     8,    11,    95,    29,
      23,     6,    25,     8,    27,    26,    74,    75,    26,    24,
      78,    28,    23,    29,    27,    11,    25,    25,    28,    23,
      22,    28,    23,    26,     4,     4,    26,    26,    26,    24,
      23,    22,    74,    78,    31,    75
};
...
{
       0,     6,     8,    35,    36,    37,    38,    39,    40,     0,
      37,    11,    23,    25,    27,     8,    39,    41,    42,    43,
      10,    11,    26,    24,    28,    27,    29,    44,    43,    23,
      28,    45,    38,    39,    46,    11,     5,     7,     9,    10,
      11,    23,    25,    30,    44,    47,    48,    49,    50,    51,
      52,    53,    54,    56,    58,    60,    61,    25,    23,    52,
      25,    25,    27,    52,    23,    22,    12,    13,    16,    17,
      18,    19,    20,    21,    55,    57,    14,    15,    59,    52,
      23,    52,    52,    62,    63,    52,    26,    52,    53,    56,
      58,    60,    26,    26,    26,    24,    28,    47,    47,    52,
       4,    47
};
...
#line 64 "cminus.y" /* yacc.c:1646  */
    { (yyval.node) = newDecNode(VarK);
						(yyval.node)->attr.name = (yyvsp[-1].str);
						(yyval.node)->type = (yyvsp[-2].Type);
					}
...
#line 69 "cminus.y" /* yacc.c:1646  */
    { TreeNode* temp = newExpNode(ConstK);
						(yyval.node) = newDecNode(VararrK);
						(yyval.node)->attr.name = (yyvsp[-4].str);
						if((yyvsp[-5].Type) == 1) (yyval.node)->type = Intarr;
						else (yyval.node)->type = (yyvsp[-5].Type);
						(yyval.node)->child[0] = temp;
						temp->attr.val = (yyvsp[-2].val);
					}
...
#line 84 "cminus.y" /* yacc.c:1646  */
    { (yyval.node) = newDecNode(FuncK);
							(yyval.node)->attr.name = (yyvsp[-4].str);
							(yyval.node)->type = (yyvsp[-5].Type);
...
#line 94 "cminus.y" /* yacc.c:1646  */
    { (yyval.node) = newParNode(SinpK);
							(yyval.node)->type = Void;
							(yyval.node)->attr.name = NULL;
						}
...
#line 113 "cminus.y" /* yacc.c:1646  */
    { (yyval.node) = newParNode(SinpK);
							(yyval.node)->attr.name = (yyvsp[0].str);
...
#line 118 "cminus.y" /* yacc.c:1646  */
    { (yyval.node) = newParNode(ArrpK);
							(yyval.node)->attr.name = (yyvsp[-2].str);
							if((yyvsp[-3].Type) == 1) (yyval.node)->type = Intarr;
							else (yyval.node)->type = (yyvsp[-3].Type);
						}
...
#line 126 "cminus.y" /* yacc.c:1646  */
    { (yyval.node) = newStmtNode(CmstmtK);
							(yyval.node)->child[0] = (yyvsp[-2].node);
...
#line 174 "cminus.y" /* yacc.c:1646  */
    { (yyval.node) = newStmtNode(IfelseK);
...
#line 208 "cminus.y" /* yacc.c:1646  */
    { (yyval.node) = newExpNode(IdK);
							(yyval.node)->attr.name = (yyvsp[-3].str);
							(yyval.node)->child[0] = (yyvsp[-1].node);
						}
...
#line 222 "cminus.y" /* yacc.c:1646  */
    { (yyval.node) = newExpNode(OpK); (yyval.node)->attr.op = LT; }
#line 1671 "y.tab.c" /* yacc.c:1646  */
    break;

  case 42:
#line 223 "cminus.y" /* yacc.c:1646  */
    { (yyval.node) = newExpNode(OpK); (yyval.node)->attr.op = LE; }
#line 1677 "y.tab.c" /* yacc.c:1646  */
    break;

  case 43:
#line 224 "cminus.y" /* yacc.c:1646  */
    { (yyval.node) = newExpNode(OpK); (yyval.node)->attr.op = GT; }
#line 1683 "y.tab.c" /* yacc.c:1646  */
    break;

  case 44:
#line 225 "cminus.y" /* yacc.c:1646  */
    { (yyval.node) = newExpNode(OpK); (yyval.node)->attr.op = GE; }
#line 1689 "y.tab.c" /* yacc.c:1646  */
    break;

  case 45:
#line 226 "cminus.y" /* yacc.c:1646  */
    { (yyval.node) = newExpNode(OpK); (yyval.node)->attr.op = EQ; }
#line 1695 "y.tab.c" /* yacc.c:1646  */
    break;

  case 46:
#line 227 "cminus.y" /* yacc.c:1646  */
    { (yyval.node) = newExpNode(OpK); (yyval.node)->attr.op = NE; }
...
#line 238 "cminus.y" /* yacc.c:1646  */
    { (yyval.node) = newExpNode(OpK); (yyval.node)->attr.op = PLUS; }
#line 1722 "y.tab.c" /* yacc.c:1646  */
    break;

  case 50:
#line 239 "cminus.y" /* yacc.c:1646  */
    { (yyval.node) = newExpNode(OpK); (yyval.node)->attr.op = MINUS; }
...
#line 250 "cminus.y" /* yacc.c:1646  */
    { (yyval.node) = newExpNode(OpK); (yyval.node)->attr.op = TIMES; }
#line 1749 "y.tab.c" /* yacc.c:1646  */
    break;

  case 54:
#line 251 "cminus.y" /* yacc.c:1646  */
    { (yyval.node) = newExpNode(OpK); (yyval.node)->attr.op = OVER; }
...
#line 257 "cminus.y" /* yacc.c:1646  */
    { (yyval.node) = newExpNode(ConstK); (yyval.node)->attr.val = (yyvsp[0].val); }
