...
{
       0,    43,    43,    47,    56,    59,    60,    63,    68,    78,
      79,    82,    91,    92,    99,   108,   111,   116,   123,   130,
     139,   142,   151,   154,   155,   156,   157,   158,   161,   162,
     166,   171,   179,   186,   188,   193,   198,   201,   205,   212,
     217,   220,   221,   222,   223,   224,   225,   228,   233,   236,
     237,   240,   245,   248,   249,   252,   253,   254,   255,   258,
     265,   266,   269,   278
};
#endif
...
#line 93 "cminus.y" /* yacc.c:1646  */
    { (yyval.node) = newParNode(SinpK);
							...
							(yyval.node)->attr.name = copyString("null");
						}
